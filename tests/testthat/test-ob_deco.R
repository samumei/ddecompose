...
#   # overall
#   testthat::expect_equal(ddeco_results$ob_deco$decomposition_terms$Composition_effect[1] * -1,
...
#                          unexplained)
#   testthat::expect_equal(deco_results$ob_deco$decomposition_terms$Structure_effect[2:5],
...
#
#   testthat::expect_equal(deco_results$ob_deco$decomposition_terms$Composition_effect[2:5],
