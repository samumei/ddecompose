...
#
# Dataset is not attached to the package but available upon request.
#
# # Reading the data
# library("dplyr")
# library("readstata13")
#
#
# men8816 <- read.dta13("data-raw/validation_data/morgm_all8816.dta")
#
...
# cpi_month <- read.dta13("data-raw/validation_data/cpimonth.dta")
#
