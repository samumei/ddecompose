...
can reduce computation time. By default, 100 bootstrap replications are calculated. 
...
The default method for fitting and predicting conditional probabilities, used to derive the reweighting factor, is a logit model. However, you can also use `reweighting_method = "fastglm"` to fit a logit model with the fast algorithm of **fastglm**, or `random_forest` to estimate the conditional probabilities with the **ranger** implementation of random forest.
