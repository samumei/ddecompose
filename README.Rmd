...
For Oaxaca-Blinder decompositions, the function displays per default standard errors under the assumption of independence between the groups and homoscedasticity.
```{r eval=TRUE}
