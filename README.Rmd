...
# 
# for(i in 1:9){
#   deciles_decomposition[[i]]$model_fits <- NULL
# }
# save(deciles_decomposition, file = "data-raw/deciles_decomposition.rda")

load("data-raw/deciles_decomposition.rda")
plot(deciles_decomposition)
```
...
load("data-raw/custom_decomposition.rda")
plot(custom_decomposition)
```
...
load("data-raw/flf_male_inequality.rda")
```
