...
The results presented below are similar to those in Table 4 of  Firpo et al. (2018, p. 30). However, some coefficients computed here deviate by several percentages from the results in the paper. 
