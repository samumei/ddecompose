...
by industry ($F(x_1 \mid x_2)$) or the industry employment given union coverage
($F(x_2 \mid x_1)$).
...
Fortin et al. 2011, p. 48-51). This approach has the valuable side effect of 
