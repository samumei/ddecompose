...
For instance, if we are intereseted in the outcomes of group 0 with 
...
Moreover, we get different results if do not manipulate the marginal covariate 
distribution $X_2$ (e.g., industry disribution) but the conditional distribution 
